  ...
  async function submit(e: React.FormEvent) {
    ...
    try {
      ...
      if (!r.ok) {
        ...
        setErr(msg ?? "Неверный логин или пароль");
        return;
      }
      ...
      <div style={{ width: "100%", maxWidth: 380, padding: "0 16px" }}>
        ...
        >
          <label style={{ display: "flex", flexDirection: "column", gap: 6 }}>
            <span style={{ fontSize: 13, fontWeight: 500, color: "#aaa" }}>Логин</span>
            <input
              value={login}
          ...
          <label style={{ display: "flex", flexDirection: "column", gap: 6 }}>
            <span style={{ fontSize: 13, fontWeight: 500, color: "#aaa" }}>Пароль</span>
            <input
              type="password"
              value={password}
